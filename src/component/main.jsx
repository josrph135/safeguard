  ...
  return (
    ...
    <main id='Home' className='flex h-screen flex-col gap-10 md:gap-20 pt-20  relative'>
        ...
        <motion.div
            ...
            className='z-10'
        >
            <a className='px-6 z-10 py-3 w-fit  md:text-lg rounded-full bg-primary-0/50 text-base border duration-500 hover:bg-white hover:text-slate-700 capitalize font-semibold' href="#Appointment">Request appointment</a>
        </motion.div>
